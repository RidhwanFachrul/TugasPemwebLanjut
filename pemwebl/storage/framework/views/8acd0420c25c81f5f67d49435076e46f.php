                            ...
                            <div class="card bg-dark shadow-2-strong">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <br>
                                    <form action="<?php echo e(route('app.store')); ?>" method="post" class="d-flex flex-column align-items-center gap-2 p-2 rounded-2 bg-black">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\pemwebl\resources\views/app.blade.php ENDPATH**/ ?>